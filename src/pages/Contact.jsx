                ...
                <div className="space-y-6 flex-grow">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a 
                        href="mailto:sameersrivastav83033@gmail.com" 
                        className="text-indigo-300 hover:text-indigo-200 transition-colors"
                      >
                        sameersrivastav83033@gmail.com
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a 
                        href="https://www.linkedin.com/in/sameer-srivastava2005/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-indigo-300 hover:text-indigo-200 transition-colors"
                      >
                        linkedin.com/in/sameer-srivastava2005/
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a 
                        href="https://github.com/SAMEER-SRIVASTAVA2005"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-indigo-300 hover:text-indigo-200 transition-colors"
                      >
                        github.com/SAMEER-SRIVASTAVA2005
                      </a>
                    </div>
                  </div>
                </div>
