...
const Achievements = () => {
  ...
  const achievements = [
    ...
    },
    {
      ...
      description: "Solved 100 coding questions on LeetCode in November 2025, strengthening problem-solving and algorithmic thinking.",
      date: "November 2025",
      icon: "💡",
    },
    {
      title: "250+ GfG Questions Solved",
      description: "Solved 250+ coding problems on GeeksforGeeks, strengthening problem-solving skills and improving understanding of data structures and algorithms.",
      date: "May 2025",
      icon: "💡",
    },
    {
        ...
        <div className={`transition-all duration-1000 ${isLoaded ? 'opacity-100 transform-none' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="space-y-6 md:space-y-8">
            {achievements.map((item, index) => (
              <div
                key={index}
                className={`group relative bg-slate-800 bg-opacity-50 backdrop-blur-sm rounded-xl overflow-hidden shadow-lg hover:shadow-indigo-500/20 transition-all duration-500 border border-slate-700 hover:border-indigo-500/50 ${isLoaded
          ...
          <div
            className={`mt-10 text-center transition-opacity duration-500 ${isLoaded ? 'opacity-100' : 'opacity-0'
              }`}
