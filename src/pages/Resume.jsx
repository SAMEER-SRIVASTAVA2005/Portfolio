...
const Resume = () => {
  ...
  const resumeData = {
    ...
    skills: [
      ...
      { category: "Tools and Libraries", items: ["ReactJS", "NodeJS", "ExpressJS", "MongoDB", "MySQL", "Tailwind", "GitHub"] },
      { category: "Soft Skills", items: ["Problem-Solving", "Critical Thinking", "Quick learner", "Adaptability"] }
    ],
    projects: [
      {
        title: "ClassAid",
    ...
    contact: {
      email: "sameersrivastav83033@gmail.com",
      mobile: "+91-8303349578",
      linkedin: "https://www.linkedin.com/in/sameer-srivastava2005/",
      github: "https://github.com/SAMEER-SRIVASTAVA2005"
    }
  };
