...
const Skills = () => {
  ...
  const skills = {
    ProgrammingLanguages: [
      ...
      { name: "C++", icon: "/icons/cpp.png", proficiency: 80 },
      { name: "Java", icon: "/icons/java.png", proficiency: 80 },
      { name: "Python", icon: "/icons/python.png", proficiency: 70 },
    ],
    Frontend: [
      { name: "React", icon: "/icons/react.png", proficiency: 80 },
    ...
    Tools: [
      { name: "Git", icon: "/icons/git.png", proficiency: 95 },
